...
public class Main
{
    ...
    {
        // Assuming the menu index corresponds to country code values in the menu structure
    switch (choice) {
        case 1: // Add New Contact
            return 1; // Replace with the actual country code for the first option
        case 2: // Edit Contact
            return 2; // Replace with the actual country code for the second option
        case 3: // Delete Contact
            return 3; // Replace with the actual country code for the third option
        // Add more cases as needed
        default:

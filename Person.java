public class Person implements Comparable<Person> {
    ...
    /**
     * @return Full contact number of this person: Country Code + Area Code +
     *         Contact Number
     */
    ...
    /**
     * Compare the lexicographic order of this person object and another person
     * object. <br>
     * <br>
     * Must compare by last name first, and then first name if both person objects
     * have the same
     * last name. Assume that no two or more person objects will share the same
     * first name.
     * 
     * @param o The person object to be compared.
     * @return Lexicographic flag if this person object should go first before the
     *         other person
     *         object. <br>
     *         <br>
     *         -1 if this person object should go first. <br>
     *         <br>
     *         0 if both person objects share the same last name and first name.
     *         <br>
     *         <br>
